...
import { MOCK_STUDENTS, DAYS_ORDER, DayOfWeek, Exercise, DailyWorkout, Student, EXERCISES } from '@/lib/data';
...
export default function AlunoDashboardClient({ initialStudent }: { initialStudent: any }) {
  const student: Student = {
    ...initialStudent,
    weeklyPlan: initialStudent.weeklyPlan.map((w: any) => ({
      ...w,
